...
# 🚨 A PORTA ESCANCARADA (Liberando o CORS geral para o nosso teste)
CORS_ALLOW_ALL_ORIGINS = True
CORS_ALLOW_CREDENTIALS = True

# As regras antigas estão comentadas. Depois do teste, nós as reativamos.
...
# ✅ Adicionado: Lista VIP de domínios atualizada com a Vercel
CSRF_TRUSTED_ORIGINS = [
    'https://req-20261-t01-morfoblocosdigital-production.up.railway.app',
    'https://req-2026-1-t01-morfo-blocos-digital.vercel.app', # Vercel adicionada aqui para evitar bloqueios silenciosos
]